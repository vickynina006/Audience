...
export default function NavModal({ translate }) {
  return (
    <nav
      className={`fixed flex flex-col min-h-screen z-40 gap-14 bg-darkblue2 pt-10 px-8 w-full transition-all duration-300 ease-in-out transform ${translate} top-0 right-0 z-10 md:px-20  mdx:hidden `}
    >
